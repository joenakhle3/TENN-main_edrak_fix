...
from tenn_ai.fabric_ai.generate_ai.camel.messages import (
...
from tenn_ai.fabric_ai.generate_ai.camel.prompts import CodePrompt, TextPrompt
...
class BaseMessage:
    ...
    def token_len(self, model: ModelType = ModelType.GPT_3_5_TURBO) -> int:
        ...
        """
        from tenn_ai.fabric_ai.generate_ai.camel.utils import num_tokens_from_messages
