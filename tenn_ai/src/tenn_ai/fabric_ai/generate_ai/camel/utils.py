...
from tenn_ai.fabric_ai.generate_ai.camel.messages import OpenAIMessage
from tenn_ai.fabric_ai.generate_ai.camel.typing import ModelType, TaskType
...
def openai_api_key_required(func: F) -> F:
    ...
    def wrapper(self, *args, **kwargs):
        from tenn_ai.fabric_ai.generate_ai.camel.agents.chat_agent import ChatAgent
